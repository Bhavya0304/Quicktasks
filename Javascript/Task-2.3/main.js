...
generateReport = ()=>{
    var isValid = true;
    Array.from(document.querySelectorAll('.editableable tbody tr')).forEach((element)=>{
...
var removeOutlineClass = (ele)=>{
    if(ele.classList.contains('pass')){
        ...
        ele.classList.add('curr-active');
        ele.nextElementSibling.classList.replace('btn-danger','btn-outline-danger');
        ele.nextElementSibling.classList.remove('curr-active');
    }
    else{
        ...
        ele.previousElementSibling.classList.remove('curr-active');
...
var secondReducer = (obj)=>{
    ...
    var newData = [];
    console.log(tempObj);
    Array.from(document.querySelectorAll('.editableable tbody tr')).forEach((element,index)=>{
       var content = element.querySelector('.content');
       if(!content.querySelector('.curr-active').classList.contains('fail')){
